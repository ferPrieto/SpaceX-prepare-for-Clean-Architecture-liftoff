...
import ferprieto.shared.ui.theme.SpaceX.LocalColors
import ferprieto.shared.ui.theme.SpaceX.LocalTypography
    ...
    Box {
        Row(
            ...
            if (youTubeLinkState.value.isNotBlank()) {
                Text(
                    text = stringResource(id = ferprieto.shared.ui.R.string.bottom_sheet_youtube),
                    modifier = Modifier
                ...
                Image(
                    painter = painterResource(ferprieto.shared.ui.R.drawable.ic_youtube),
            ...
            if (wikipediaLinkState.value.isNotBlank()) {
                Text(
                    text = stringResource(id = ferprieto.shared.ui.R.string.bottom_sheet_wikipedia),
                    modifier = Modifier
                        .padding(end = 16.dp)
                        .align(Alignment.CenterVertically)
                        .clickable {
                ...
                Image(
                    painter = painterResource(ferprieto.shared.ui.R.drawable.ic_wikipedia),
