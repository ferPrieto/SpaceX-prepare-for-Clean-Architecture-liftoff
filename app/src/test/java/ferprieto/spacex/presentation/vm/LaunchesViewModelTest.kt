package ferprieto.spacex.presentation.vm

import androidx.arch.core.executor.testing.InstantTaskExecutorRule
import ferprieto.domain.model.LaunchDomainModel
import ferprieto.domain.model.LinksDomainModel
import ferprieto.domain.model.RocketDomainModel
import ferprieto.domain.usecase.GetLaunches
import ferprieto.shared.testing.util.buildDate
import ferprieto.spacex.presentation.screens.launches.LaunchUiModel
import ferprieto.spacex.presentation.screens.launches.LinksUiModel
import ferprieto.spacex.presentation.screens.launches.RocketUiModel
import ferprieto.spacex.presentation.vm.mapper.ClickableLinkProvider
import ferprieto.spacex.presentation.vm.mapper.LaunchesDomainToUiModelMapper
...
class LaunchesViewModelTest {
    ...
    fun `When launches Then launchUiModelRetrieved with expected result`() {
        runBlockingTest {
            ...
            coEvery { getLaunches.execute(0, false) } returns
                flow {
