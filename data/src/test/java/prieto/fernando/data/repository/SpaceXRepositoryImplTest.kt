...
class SpaceXRepositoryImplTest {
    ...
    @Test
    fun `When getCompanyInfo then spaceXRemoteSource invoked`() = testCoroutineRule.runBlockingTest {
        // Given
    ...
    @Test
    fun `When getAllLaunches then spaceXRemoteSource invoked`() = testCoroutineRule.runBlockingTest {
        // Given
